...
<html lang="en">
  ...
  <!--La parte nav representa una seccion que ofrece enlaces de navegacion tanto internos como externos -->
    <nav>
      ...
      <article>
	  <!--Abrimos un form que representa un formulario y en el metemos la etiqueta table para crear una tabla-->
    <form style="overflow-y: auto;" id="formulario"   action='formulario_insertar.php' method="post">     
      <table class= "tabla" >
      <!--Dentro de la tabla colocamos un conjuntos de input que recogeran los distintos datos del usuario -->
      <!--Estos imput a su vez esta aen un div que los divide para una colocarlos en unas posiciones determinadas-->
      <!-- Estos imput a su vez estan divididos por parrafor que sinbolizamos con p -->
      <p  class="titulosRegistro">DATOS DE USUARIO</p>
      <!--Tambien usaremos el comando &nbsp; para generar espacion en blanco-->
      <div id="nickRegistro" >  Nick: &nbsp;&nbsp;&nbsp;&nbsp;  <input   type="text" name="nick" size="25" maxlength="50"> 
      <div id="contraseñaRegistro"> Password: <input  type="password" name="password" size="25" maxlength="250"></div> </div>
      <p class="titulosRegistro">DATOS PERSONALS</p> 
      <div id="nombreRegistro">  Nombre: <input  type="text"  name="nombre" size="25" maxlength="50">    
      <div id="apellidosRegistro">  Apellidos: <input type="text" name="apellidos" size="25" maxlength="100"> </div> </div>
      <div id="telefonoRegistro">	Telefono:<input type="text" name="telefono" size="25" value="" size="12">
      <div id="correoRegistro">  Email:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" value="" name="correo" size="25" maxlength="100"></div></div>
			<div id="edadRegistro">	Edad:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input  type="text" name="edad" size="25" value=""> </div>
			<p class="titulosRegistro">INFORMACION EXTRA</p> 
      <div id="conocerRegistro">  ¿Como nos conocistes?<textarea cols="70" rows="1" name="como"> </textarea></div>
      <div id="opinionRegistro">  ¿Que sabes de nosotros?<textarea cols="70" rows="1" name="opinion"> </textarea>
      <div id="opinionRegistro"> Tu opinion cuenta<textarea cols="70" rows="1" name="sugerencias"></textarea></div>
