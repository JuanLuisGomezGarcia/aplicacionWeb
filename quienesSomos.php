...
<html lang="en">
  ...
  <!--La parte nav representa una seccion que ofrece enlaces de navegacion tanto internos como externos -->
    <nav>
      ...
      <article>
<!-- Con junto de etiquetas para la escritituras los h son para reflejar titulos y los p parrafos-->
        <div  id="quienesSomos">
          <h1>¿QUIENES SOMOS? </h1>
          <h2>Autores </h2>
          <p>Francisco Javier Palomo y Juan Luis Gomez Garcia </p>
          <h3>Descripcion </h3>
          <p>Proyecto para la UF13 del modulo de desarrollo de </p>
          <p>aplicaciones multiplataformas de linkia</p>
          <h4>Localizacion </h4>
          <p>España</p>
        </div>
