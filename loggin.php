...
<html lang="en">
  ...
  <!--La parte nav representa una seccion que ofrece enlaces de navegacion tanto internos como externos -->
    <nav>
      ...
      <header>
      <!-- Esta funcion php usa un cookie para guardar el inicio de secion el cookie almacena el nombre de usuario y conecta a la  -->
      <!-- funsion que inicia sesion la cual termina de completar la logica-->
      <?php if(isset($_COOKIE["nombre_usuario4"])){header("location:secionIniciada.php");}?>	
	  ...
	  <article>
	  <!-- Aqui usamos un form para introducir los datos para logearse al marcar el checkbox recuerda el usuario-->
    <form id="login" action="comprueba_login.php" method="post">     
    <table class= "tabla" >
	<tr><td colspan="2" align="center">INTRODUCE TUS DATOS</td></tr>
      <tr><td align="center">Usuario:</td><td align="center"><input type="text" name="login"></td> </tr>
      <tr><td align="center" >Password:</td><td><input type="password" name="password"></td></tr>
      <tr ><td align="center" id="recordarUsuario" >recordar usuario</td><td><input type="checkbox" name="recordar" id="recordar"></td></tr>
      <tr><td colspan="2" align="center"><input type="submit" name="enviar" value="LOGIN"></td></tr>
    </table>
	</form>   
